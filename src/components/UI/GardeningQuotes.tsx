...
export default function GardeningQuotes() {
  ...
  return (
    <div className="bg-[#c1f8d5] dark:bg-gray-600 p-6 rounded-lg shadow-lg max-w-2xl mx-auto my-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          <Leaf className="text-primary dark:text-white mr-2" size={24} />
          <h2 className="text-md font-semibold text-primary dark:text-white">Gardening Wisdom</h2>
        </div>
      ...
      >
        <p className="text-xs text-primary dark:text-white italic mb-2">{quote.text}</p>
